Contributing to BLOOD_BOUND_MASTERNODE Core
============================

The BLOOD_BOUND_MASTERNODE Core project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *Qt* for changes to BLOOD_BOUND_MASTERNODE-qt
  - *Minting* for changes to the minting code
  - *Net* or *P2P* for changes to the peer-to-peer network code
  - *RPC/REST* for changes to the RPC or REST APIs
  - *Scripts and tools* for changes to the scripts and tools
  - *Tests* for changes to the BLOOD_BOUND_MASTERNODE unit tests or QA tests
...
The following applies to code changes to the BLOOD_BOUND_MASTERNODE Core project, and is not to be
confused with overall BLOOD_BOUND_MASTERNODE Network Protocol consensus changes.

Whether a pull request is merged into BLOOD_BOUND_MASTERNODE Core rests with the project merge
...
Patches that change BLOOD_BOUND_MASTERNODE consensus rules are considerably more involved than
...
Where a patch set proposes to change the BLOOD_BOUND_MASTERNODE consensus, it must have been
...
The project leader is the release manager for each BLOOD_BOUND_MASTERNODE Core release.
