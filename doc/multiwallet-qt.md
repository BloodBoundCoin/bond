...
In order to support loading of multiple wallets in BLOOD_BOUND_MASTERNODE-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is BLOOD_BOUND_MASTERNODE.cpp.
...
Changes to BLOOD_BOUND_MASTERNODE.cpp
----------------------
BLOOD_BOUND_MASTERNODE.cpp is the entry point into BLOOD_BOUND_MASTERNODE-qt, and as such, will require some minor modifications to provide hooks for
