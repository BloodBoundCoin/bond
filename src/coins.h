...
/** 
    ...
    ****Note - for BLOOD_BOUND_MASTERNODE we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of BLOOD_BOUND_MASTERNODE coming in to a transaction
