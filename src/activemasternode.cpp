...
//
// Bootup the Masternode, look for a 10000 BOND input and register on the network
//
void CActiveMasternode::ManageStatus()
{
    ...
    if (status != ACTIVE_MASTERNODE_STBONDED) {
        // Set defaults
        ...
        if (GetMasterNodeVin(vin, pubKeyCollateralAddress, keyCollateralAddress)) {
            ...
            status = ACTIVE_MASTERNODE_STBONDED;
...
std::string CActiveMasternode::GetStatus()
{
    ...
    case ACTIVE_MASTERNODE_STBONDED:
