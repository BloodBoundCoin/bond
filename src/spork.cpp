...
// BLOOD_BOUND_MASTERNODE: on startup load spork values from previous session if they exist in the sporkDB
void LoadSporksFromDB()
{
    for (int i = SPORK_STBOND; i <= SPORK_END; ++i) {
...
void ProcessSpork(CNode* pfrom, std::string& strCommand, CDataStream& vRecv)
{
    ...
    if (strCommand == "spork") {
        ...
        // BLOOD_BOUND_MASTERNODE: add to spork database.
