...
//! BLOOD_BOUND_MASTERNODE RPC error codes
enum RPCErrorCode {
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED = -9,        //! BLOOD_BOUND_MASTERNODE is not connected
    ...
    RPC_WALLET_PASSBONDASE_INCORRECT = -14, //! The wallet passphrase entered was incorrect
