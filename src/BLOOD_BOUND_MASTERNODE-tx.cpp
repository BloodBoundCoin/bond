...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BLOOD_BOUND_MASTERNODE Core BLOOD_BOUND_MASTERNODE-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  BLOOD_BOUND_MASTERNODE-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded BLOOD_BOUND_MASTERNODE transaction") + "\n" +
                               "  BLOOD_BOUND_MASTERNODE-tx [options] -create [commands]   " + _("Create hex-encoded BLOOD_BOUND_MASTERNODE transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded BLOOD_BOUND_MASTERNODE transaction
