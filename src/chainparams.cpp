...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of(0, uint256("bdb9e3905cbdcedb61d7be2e639ec9367bd76383f7e9654d89e805e1e537323a"));
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 11007;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // BLOOD_BOUND_MASTERNODE starting difficulty is 1 / 2^12
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "This is the begining of new era";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1532781587;  //Monday, June 18, 2018 4:19:04 PM GMT
        ...
        strObfuscationPoolDummyAddress = "beax8jHDQ1s2kHVjysEoTQncVdUrNBuXtp";
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // BLOOD_BOUND_MASTERNODE: 1 day
        nTargetSpacing = 1 * 60;  // BLOOD_BOUND_MASTERNODE: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("testnet.BLOOD_BOUND_MASTERNODE.io", "testnet.BLOOD_BOUND_MASTERNODE.io"));         // Single node address
        vSeeds.push_back(CDNSSeedData("testnet1.BLOOD_BOUND_MASTERNODE.io", "testnet1.BLOOD_BOUND_MASTERNODE.io"));       // Single node address
        vSeeds.push_back(CDNSSeedData("testnet2.BLOOD_BOUND_MASTERNODE.io", "testnet2.BLOOD_BOUND_MASTERNODE.io"));       // Single node address
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // BLOOD_BOUND_MASTERNODE: 1 day
        nTargetSpacing = 1 * 60;        // BLOOD_BOUND_MASTERNODE: 1 minutes
