...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop BLOOD_BOUND_MASTERNODE server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "BLOOD_BOUND_MASTERNODE server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BLOOD_BOUND_MASTERNODE features */
        {"BLOOD_BOUND_MASTERNODE", "masternode", &masternode, true, true, false},
        {"BLOOD_BOUND_MASTERNODE", "listmasternodes", &listmasternodes, true, true, false},
        {"BLOOD_BOUND_MASTERNODE", "getmasternodecount", &getmasternodecount, true, true, false},
        {"BLOOD_BOUND_MASTERNODE", "masternodeconnect", &masternodeconnect, true, true, false},
        {"BLOOD_BOUND_MASTERNODE", "masternodecurrent", &masternodecurrent, true, true, false},
        {"BLOOD_BOUND_MASTERNODE", "masternodedebug", &masternodedebug, true, true, false},
        {"BLOOD_BOUND_MASTERNODE", "startmasternode", &startmasternode, true, true, false},
        {"BLOOD_BOUND_MASTERNODE", "createmasternodekey", &createmasternodekey, true, true, false},
        {"BLOOD_BOUND_MASTERNODE", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"BLOOD_BOUND_MASTERNODE", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"BLOOD_BOUND_MASTERNODE", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"BLOOD_BOUND_MASTERNODE", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"BLOOD_BOUND_MASTERNODE", "getmasternodescores", &getmasternodescores, true, true, false},
        {"BLOOD_BOUND_MASTERNODE", "mnbudget", &mnbudget, true, true, false},
        {"BLOOD_BOUND_MASTERNODE", "preparebudget", &preparebudget, true, true, false},
        {"BLOOD_BOUND_MASTERNODE", "submitbudget", &submitbudget, true, true, false},
        {"BLOOD_BOUND_MASTERNODE", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"BLOOD_BOUND_MASTERNODE", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"BLOOD_BOUND_MASTERNODE", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"BLOOD_BOUND_MASTERNODE", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"BLOOD_BOUND_MASTERNODE", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"BLOOD_BOUND_MASTERNODE", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"BLOOD_BOUND_MASTERNODE", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"BLOOD_BOUND_MASTERNODE", "checkbudgets", &checkbudgets, true, true, false},
        {"BLOOD_BOUND_MASTERNODE", "mnsync", &mnsync, true, true, false},
        {"BLOOD_BOUND_MASTERNODE", "spork", &spork, true, true, false},
        {"BLOOD_BOUND_MASTERNODE", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"BLOOD_BOUND_MASTERNODE", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use BLOOD_BOUND_MASTERNODEd, or the -server option to BLOOD_BOUND_MASTERNODE-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               "It is recommended you use the following random password:\n"
                                               "rpcuser=BLOOD_BOUND_MASTERNODErpc\n"
                                               "rpcpassword=%s\n"
                                               "(you do not need to remember this password)\n"
                                               "The username and password MUST NOT be the same.\n"
                                               "If the file does not exist, create it with owner-readable-only file permissions.\n"
                                               "It is also recommended to set alertnotify so you are notified of problems;\n"
                                               "for example: alertnotify=echo %%s | mail -s \"BLOOD_BOUND_MASTERNODE Alert\" admin@foo.com\n"),
...
{
    return "> BLOOD_BOUND_MASTERNODE-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:12007/\n";
}
