                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BLOOD BOUND MASTERNODE Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BLOOD BOUND MASTERNODE address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and BLOOD BOUND MASTERNODE: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zBOND"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BLOOD BOUND MASTERNODE Core"), this);
    aboutAction->setStatusTip(tr("Show information about BLOOD BOUND MASTERNODE Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BLOOD BOUND MASTERNODE"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BLOOD BOUND MASTERNODE addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BLOOD BOUND MASTERNODE addresses"));
    ...
    openAction->setStatusTip(tr("Open a BLOOD BOUND MASTERNODE: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BLOOD BOUND MASTERNODE Core help message to get a list with possible BLOOD BOUND MASTERNODE command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BLOOD BOUND MASTERNODE Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BLOOD BOUND MASTERNODE network", "", count));
}
...
{
    QString strTitle = tr("BLOOD BOUND MASTERNODE Core"); // default title
    ...
    // Append title to "BLOOD_BOUND_MASTERNODE - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
