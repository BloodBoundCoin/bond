...
#include "ui_zBLOOD_BOUND_MASTERNODEcontroldialog.h"
...
std::list<std::string> ZBLOOD_BOUND_MASTERNODEControlDialog::listSelectedMints;
std::list<CZerocoinMint> ZBLOOD_BOUND_MASTERNODEControlDialog::listMints;

ZBLOOD_BOUND_MASTERNODEControlDialog::ZBLOOD_BOUND_MASTERNODEControlDialog(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::ZBLOOD_BOUND_MASTERNODEControlDialog),
    model(0)
{
    ui->setupUi(this);
    listMints.clear();
...
ZBLOOD_BOUND_MASTERNODEControlDialog::~ZBLOOD_BOUND_MASTERNODEControlDialog()
{
    delete ui;
}

void ZBLOOD_BOUND_MASTERNODEControlDialog::setModel(WalletModel *model)
{
    this->model = model;
    updateList();
}
...
void ZBLOOD_BOUND_MASTERNODEControlDialog::updateList()
{
...
void ZBLOOD_BOUND_MASTERNODEControlDialog::updateSelection(QTreeWidgetItem* item, int column)
{
...
void ZBLOOD_BOUND_MASTERNODEControlDialog::updateLabels()
{
    int64_t nAmount = 0;
    for (const CZerocoinMint mint : listMints) {
    ...
    ui->labelZBLOOD_BOUND_MASTERNODE_int->setText(QString::number(nAmount));
    ui->labelQuantity_int->setText(QString::number(listSelectedMints.size()));

    //update PrivacyDialog labels
    privacyDialog->setZBLOOD_BOUND_MASTERNODEControlLabels(nAmount, listSelectedMints.size());
}

std::vector<CZerocoinMint> ZBLOOD_BOUND_MASTERNODEControlDialog::GetSelectedMints()
{
...
void ZBLOOD_BOUND_MASTERNODEControlDialog::ButtonAllClicked()
{
    ui->treeWidget->blockSignals(true);
