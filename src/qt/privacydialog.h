...
public:
    ...
    void setZBLOOD_BOUND_MASTERNODEControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzBOND_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzBOND_clicked();
    void on_pushButtonZBLOOD_BOUND_MASTERNODEControl_clicked();
