                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received BLOOD BOUND MASTERNODE from zBLOOD BOUND MASTERNODE"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zBLOOD BOUND MASTERNODE"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zBLOOD_BOUND_MASTERNODE));
