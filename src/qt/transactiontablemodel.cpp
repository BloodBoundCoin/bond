...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted BLOOD BOUND MASTERNODE to zBLOOD BOUND MASTERNODE");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zBLOOD BOUND MASTERNODE");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received BLOOD BOUND MASTERNODE from zBLOOD BOUND MASTERNODE");
    case TransactionRecord::ZerocoinSpend_Change_zBLOOD_BOUND_MASTERNODE:
        return tr("Minted Change as zBLOOD BOUND MASTERNODE from zBLOOD BOUND MASTERNODE Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zBLOOD BOUND_MASTERNODE to BLOOD BOUND_MASTERNODE");
...
QString TransactionTableModel::formatTxToAddress(const TransactionRecord* wtx, bool tooltip) const
{
    ...
    case TransactionRecord::ZerocoinMint:
    case TransactionRecord::ZerocoinSpend_Change_zBLOOD_BOUND_MASTERNODE:
        return tr("zBLOODBOUND MASTERNODE Accumulator");
    case TransactionRecord::SendToSelf:
    default:
