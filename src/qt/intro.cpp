...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("BLOOD BOUND MASTERNODE Core"),
     ...
     * override -datadir in the BLOOD_BOUND_MASTERNODE.conf file in the default data directory
     * (to be consistent with BLOOD_BOUND_MASTERNODEd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
