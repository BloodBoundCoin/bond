...
#define MASTERNODE_COLLATERAL (5000 * COIN)
#define MASTERNODE_COLLATERAL_LIMIT (MASTERNODE_COLLATERAL - 0.01 * COIN)
#define MASTERNODE_PORT 11007
...
//
// The Masternode Class. For managing the Obfuscation process. It contains the input of the 10000 BOND, signature to prove
